    ...
    return (
        <div>
            <Scene>
                ...
                <a-video id="screen3" data-brackets-id="644" src="#video" position="3.1 2 -1.55" material="" geometry="width: 1.6; height: 1.5" rotation="0 120 0" />

                {/* <!--radio--> */}
                <a-entity data-brackets-id="327" id="yellow" gltf-model="radio/scene.gltf" position="9.11851 0.45804 -7.96256" sound="src: mpi,Benjamin%20-%20Inferno.mp3" scale="0.2 0.2 0.2" rotation="0 17.71 0">
                ...
                <a-entity data-brackets-id="1806" gltf-model="window/scene.gltf" position="3.82 -1.0 7.7" scale="0.04 0.074 0.04" rotation="0 60 0"></a-entity>
                <a-box data-brackets-id="845" color="white" position="-7.3 2 7.5" material="" geometry="height: 4; width: 5; depth: 0.2"></a-box>
                <a-entity data-brackets-id="1808" gltf-model="window/scene.gltf" position="-3.86296 -1.0 7.7" scale="0.04 0.073 0.04" rotation="0 60 0"></a-entity>
                ...
                <a-entity data-brackets-id="3153" gltf-model="sliding_window/scene.gltf" position="-9.93211 1 0.44978" scale="0.0106 0.021 0.03" rotation="0 -90 0"></a-entity>
                ...
                <a-entity data-brackets-id="3224" gltf-model="sliding_window/scene.gltf" position="-9.93211 1 5.46438" scale="0.011 0.021 0.03" rotation="0 -90 0"></a-entity>
                <a-box data-brackets-id="3234" geometry="depth: 4.06; height: 4; width: 0.2" color="white" position="-9.9 2 7.96626" ></a-box>
                {/* <!--lamp--> */}
                {/* <a-entity gltf-model="Unity2Skfb/Unity2Skfb.gltf" position="3 3 3"></a-entity> */}
                {/* <a-entity data-brackets-id="807" gltf-model="Unity2Skfb/Unity2Skfb.gltf" position="8 2 9"></a-entity> */}
                ...
                <a-entity data-brackets-id="70" gltf-model="3d_architecture__photo_frame/scene.gltf" position="0.52 3.041 -9.8" rotation="0 -90 0" scale="1 0.8 1.7"></a-entity>
                <a-entity data-brackets-id="67" gltf-model="3d_architecture__photo_frame/scene.gltf" position="-0.464 2.3 -9.8" rotation="0 -90 0" scale="1 0.9 1.5"></a-entity>
                <a-entity data-brackets-id="32" gltf-model="3d_architecture__photo_frame/scene.gltf" position="0.51 1.85 -9.8" rotation="0 -90 0" scale="1 2 1.7"></a-entity>
                <a-entity data-brackets-id="68" gltf-model="3d_architecture__photo_frame/scene.gltf" position="-0.31 1.46 -9.8" rotation="0 -90 0"></a-entity>
                <a-entity data-brackets-id="71" gltf-model="3d_architecture__photo_frame/scene.gltf" position="-0.95 1.45 -9.8" rotation="0 -90 0"></a-entity>
                <a-entity data-brackets-id="69" gltf-model="3d_architecture__photo_frame/scene.gltf" position="1.35 2.24 -9.8" rotation="0 -90 0" scale=""></a-entity>
                ...
                {/* <!--room--> */}
                <a-entity data-brackets-id="772" gltf-model="glass_door/scene.gltf" position="-5.5 0.02 -3.8" scale="0.01 0.011 0.01"></a-entity>
                ...
                <a-entity data-brackets-id="1128" gltf-model="glass_door/scene.gltf" position="4.4801 0.02 -3.8" scale="0.011 0.011 0.01"></a-entity>
                ...
                {/* <!--Pendant Light--> */}
                <a-entity gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="0 3.1 0"></a-entity>
                ...
                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="4 3.1 0"></a-entity>
                <a-entity data-brackets-id="154" light="type: point; intensity: 0.6; distance: 9" position="4 3.2 0" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="-4 3.1 0"></a-entity>
                <a-entity data-brackets-id="154" light="type: point; intensity: 0.6; distance: 9" position="-4 3.2 0" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="-8 3.1 0"></a-entity>
                <a-entity light="type: point; intensity: 0.6; distance: 9" position="-8 3.2 0" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="8 3.1 0"></a-entity>
                <a-entity light="type: point; intensity: 0.6; distance: 9" position="8 3.2 0" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="0 3.1 5.5"></a-entity>
                <a-entity light="type: point; intensity: 0.6; distance: 9" position="0 3.2 5.5" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="Lamp/Unity2Skfb.gltf" scale="0.7 0.7 0.7" position="0 1.8 -6.5"></a-entity>
                ...
                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="4 3.1 5.5"></a-entity>
                <a-entity data-brackets-id="154" light="type: point; intensity: 0.6; distance: 9" position="4 3.2 5.5" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="Lamp/Unity2Skfb.gltf" scale="0.7 0.7 0.7" position="4 1.8 -6.5"></a-entity>
                ...
                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="-8 3.1 -6.5"></a-entity>
                <a-entity data-brackets-id="154" light="type: point; intensity: 0.6; distance: 10" position="-8 3.2 -6.5" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="8 3.1 -6.5"></a-entity>
                <a-entity data-brackets-id="154" light="type: point; intensity: 0.6; distance: 10" position="8 3.2 -6.5" shadow="true"></a-entity>

                <a-entity data-brackets-id="21" gltf-model="temple_pendant_light_and_002_plumen_bulb_brass/scene.gltf" scale="0.008 0.008 0.008" position="8 3.1 5.5"></a-entity>
                ...
                {/* <!--chair--> */}
                {/* <!--right--> */}
                <a-entity data-brackets-id="337" gltf-model="chair/scene.gltf" position="0.9 0 2.5" rotation="0 0 0" scale="0.7 0.7 0.7" ></a-entity>
                <a-entity data-brackets-id="980" gltf-model="chair/scene.gltf" position="-0.7 0 2.5" rotation="" scale="0.7 0.7 0.7"></a-entity>
                <a-entity data-brackets-id="981" gltf-model="chair/scene.gltf" position="-2.3 0 2.5" rotation="" scale="0.7 0.7 0.7"></a-entity>

                {/* <!--left--> */}
                <a-entity data-brackets-id="507" gltf-model="chair/scene.gltf" position="0.3 0 0.5" rotation="0 180 0" scale="0.7 0.7 0.7"></a-entity>
                <a-entity data-brackets-id="983" gltf-model="chair/scene.gltf" position="-1.3 0 0.5" rotation="0 180 0" scale="0.7 0.7 0.7"></a-entity>
                <a-entity data-brackets-id="987" gltf-model="chair/scene.gltf" position="-2.9 0 0.5" rotation="0 180 0" scale="0.7 0.7 0.7"></a-entity>
                {/* <!--coffeecup--> */}

                <a-entity data-brackets-id="203" gltf-model="coffee_shop_cup/scene.gltf" position="1.0 0.8 2.45" scale="0.25 0.25 0.25" ></a-entity>
                <a-entity data-brackets-id="203" gltf-model="coffee_shop_cup/scene.gltf" position="-0.5 0.8 2.45" scale="0.25 0.25 0.25"></a-entity>
                <a-entity data-brackets-id="203" gltf-model="coffee_shop_cup/scene.gltf" position="-2.2 0.8 2.45" scale="0.25 0.25 0.25"></a-entity>
                <a-entity data-brackets-id="203" gltf-model="coffee_shop_cup/scene.gltf" position="1.0 0.8 0.55" scale="0.25 0.25 0.25"></a-entity>
                <a-entity data-brackets-id="203" gltf-model="coffee_shop_cup/scene.gltf" position="-0.5 0.8 0.55" scale="0.25 0.25 0.25"></a-entity>
