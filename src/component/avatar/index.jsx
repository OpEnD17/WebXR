    ...
    return (
        <Entity id='avatar' scale="0.5 0.5 0.5" ref={avatarRef} sound={`src: #${id}audio`}>
            <Entity position="0 1.3 0">
                <Entity ref={headRef}>
                    <a-box id="head" color={`#${info[5]}`} material="" ></a-box>
                    {
                        track
                            ? <a-video src={`#${id}video`} width="1" height="1" position="0 0 0.51" material="" geometry="" />
                            : <a-plane src={`#face${faceId.current}`} width="1" height="1" position="0 0 0.51" material="side: double" />
                    }
                </Entity>
            </Entity>
